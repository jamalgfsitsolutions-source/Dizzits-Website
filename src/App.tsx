...
import { Sparkles, ArrowRight, Quote, Star, MessageSquare, CheckCircle2, Paperclip } from "lucide-react";
import {
  ArrowUpRight,
  PlayIcon,
  ClockIcon,
...
import rockImg from "./assets/images/floating_rock_asteroid_1784593928055.jpg";
import servicesBgImg from "./assets/images/dark_abstract_space_bg_1784594692676.jpg";
...
export default function App() {
  ...
  return (
    <div ref={container} className="w-full bg-black text-white selection:bg-white/30 relative overflow-hidden">
      ...
      {/* Navbar */}
      <nav className="fixed top-6 left-0 right-0 z-50 flex justify-between items-center px-8 lg:px-12">
        {/* Left */}
        <div className="liquid-glass rounded-full px-4 py-2 flex items-center justify-center">
        ...
        <div className="hidden md:flex liquid-glass rounded-full px-2 py-1.5 items-center gap-1">
          ...
          <button className="bg-white text-black px-4 py-1.5 rounded-full text-xs font-bold flex items-center gap-2 hover:bg-blue-600 hover:text-white transition-colors duration-300">
            Start a Project
      ...
      {/* Hero Section */}
      <section ref={heroRef} id="home" className="min-h-[140vh] overflow-hidden bg-black relative flex flex-col">
        <video
          autoPlay
          loop
          muted
          ...
          className="absolute inset-0 w-full h-full object-cover object-center z-0 mask-fade"
        />
        
        <div className="relative z-10 flex flex-col h-full min-h-[140vh]">
      ...
      <section ref={servicesRef} id="services" className="relative bg-[#050505] text-white overflow-hidden h-screen">
        ...
        <div className="relative z-10 w-full h-full">
          {[
            { title: "Website Development", desc: "Production-grade front-ends built on modern stacks. We craft scalable, performant, and accessible digital experiences.", img: "https://images.unsplash.com/photo-1618477388954-7852f32655ec?q=80&w=2000&auto=format&fit=crop", rightHeading: "Digital Presence" },
            { title: "Logo Design", desc: "Shaping unique visual identities for modern brands. We build foundations that scale across every medium.", img: "https://images.unsplash.com/photo-1626785774573-4b799315345d?q=80&w=2000&auto=format&fit=crop", rightHeading: "Visual Identity" },
            { title: "Mobile Application", desc: "Native and cross-platform apps built for scale and performance. Bringing your product to every pocket.", img: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=2000&auto=format&fit=crop", rightHeading: "Product Ecosystems" },
            { title: "Game Development", desc: "Immersive experiences and interactive entertainment. Form meets function in perfectly crafted interfaces.", img: "https://images.unsplash.com/photo-1552820728-8b83bb6b773f?q=80&w=2000&auto=format&fit=crop", rightHeading: "Interactive Play" },
            { title: "Digital Marketing", desc: "Data-driven marketing to expand your reach and boost conversion rates. Strategies tailored to grow your audience.", img: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=2000&auto=format&fit=crop", rightHeading: "Growth Strategies" },
            { title: "Branding", desc: "We craft concepts that define unique brands and strengthen their presence in competitive markets.", img: "https://images.unsplash.com/photo-1633409361618-c73427e4e206?q=80&w=2000&auto=format&fit=crop", rightHeading: "Brand Perception" },
            { title: "Video Animation", desc: "Creative processes with rapid delivery and visual storytelling. Movement that explains and delights.", img: "https://images.unsplash.com/photo-1536240478700-b869070f9279?q=80&w=2000&auto=format&fit=crop", rightHeading: "Motion Narratives" }
          ].map((service, idx) => (
                ...
                <div className="flex flex-col md:flex-row items-center gap-10 md:gap-20 h-full">
                  ...
                  <div className="w-full md:w-1/2 flex justify-center md:justify-end">
                    <div className="w-full max-w-md liquid-glass p-8 md:p-12 rounded-[2rem] border border-white/20 shadow-2xl backdrop-blur-2xl bg-white/5 flex flex-col hover:bg-white/10 transition-colors duration-500">
                      ...
                      <button className="group flex items-center gap-4 uppercase tracking-widest text-[11px] font-bold text-white w-fit mt-auto bg-white/10 hover:bg-white/20 px-6 py-3 rounded-full transition-all duration-300">
                        Explore Service
        ...
        <div className="relative z-10 w-full h-full flex items-center">
          <div ref={trackRef} className="flex h-[70vh] md:h-[80vh] items-center gap-10 px-[10vw] w-max">
            ...
            {[
              ...
              { title: "Vortex Aero", category: "Brand Identity", img: "https://images.unsplash.com/photo-1550745165-9bc0b252726f?q=80&w=2000&auto=format&fit=crop" },
          ...
          <form className="space-y-12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24">
              <div className="space-y-4">
                ...
                <input type="email" placeholder="Enter the Email" className="w-full bg-transparent border-b border-white/20 pb-4 text-white placeholder:text-white/30 focus:outline-none focus:border-blue-500 hover:border-blue-500/50 transition-colors text-sm font-light" />
              </div>
              <div className="space-y-4">
                <label className="text-[15px] text-white/90 font-light block">Your Phone</label>
                <input type="tel" placeholder="Enter your phone number" className="w-full bg-transparent border-b border-white/20 pb-4 text-white placeholder:text-white/30 focus:outline-none focus:border-blue-500 hover:border-blue-500/50 transition-colors text-sm font-light" />
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-wrap gap-4">
                {['Website Development', 'Logo Design', 'Mobile Application', 'Game Development', 'Digital Marketing', 'Branding', 'Video Animation'].map(interest => (
                  <button type="button" key={interest} className="px-6 py-2.5 rounded-full border border-white/20 text-white/70 text-sm font-light hover:bg-blue-600 hover:border-blue-600 hover:text-white transition-colors">
                    {interest}
                  </button>
                ))}
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-wrap gap-4">
                {['< $1,000', '$1,000 - $5,000', '$5,000 - $10,000', '$10,000 - $20,000', '> $20,000'].map(budget => (
                  <button type="button" key={budget} className="px-6 py-2.5 rounded-full border border-white/20 text-white/70 text-sm font-light hover:bg-blue-600 hover:border-blue-600 hover:text-white transition-colors">
                    {budget}
                  </button>
                ))}
              </div>
            ...
            <div className="space-y-4">
              ...
              <textarea rows={1} className="w-full bg-transparent border-b border-white/20 pb-4 pt-16 text-white focus:outline-none focus:border-blue-500 hover:border-blue-500/50 transition-colors resize-none" />
            </div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 pt-8">
              ...
              <button type="submit" className="group bg-black text-white px-3 py-3 pl-8 rounded-full flex items-center gap-6 hover:bg-blue-600 transition-colors border border-white/5 hover:border-blue-600">
      ...
      {/* Footer */}
      <footer ref={footerRef} className="bg-[#0f0f0f] pt-24 pb-8 px-8 md:px-16 lg:px-20 text-white relative overflow-hidden flex flex-col">
        <video
          autoPlay
          loop
          muted
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full flex-1 flex flex-col justify-between">
            ...
            <div>
              ...
              <ul className="space-y-3">
                {['Home', 'Services', 'Work', 'Process', 'Testimonials', 'Contact'].map((link) => (
                  <li key={link}>
                    <a href={`#${link.toLowerCase()}`} className="text-sm font-light hover:text-white/70 transition-colors">
                      {link}
                    </a>
                  </li>
                ))}
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center pt-8 md:pt-16 text-[13px] text-white/50 z-10 relative">
            ...
            <button onClick={() => window.scrollTo({top: 0, behavior: 'smooth'})} className="hover:text-white transition-colors flex items-center gap-2 mt-4 sm:mt-0 font-light">
